function [NORM]=PCF_normalisation_rectangular_sparse_zero_flux_uniform(Lx,Ly)
...
diag_right_pairs_periodic_r=zeros(Lx/2,1);
diag_right_pairs_periodic_c=zeros(Lx/2,1);
